...
class _$_NextWordEvent with DiagnosticableTreeMixin implements _NextWordEvent {
  const _$_NextWordEvent();

  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'NextWordEvent()';
  }

  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty('type', 'NextWordEvent'));
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$_NextWordEvent);
  }
...
abstract class _NextWordEvent implements NextWordEvent {
  const factory _NextWordEvent() = _$_NextWordEvent;
}
